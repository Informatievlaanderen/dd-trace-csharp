...
Target.create "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.DataDog.Tracing")
...
Target.create "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.DataDog.Tracing")
