...
Target "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.DataDog.Tracing")
...
Target "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.DataDog.Tracing")
Target "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.DataDog.Tracing")
